...
class AutomationApp(ctk.CTk):
    ...
    def __init__(self, automationCallback=None):
        ...
        # Default paths
        DEFAULT_EXCEL = r"C:\Users\Akshat Mittal\Desktop\Intuk\12001200.xlsx"
        DEFAULT_IMAGES = r"C:\Users\Akshat Mittal\Desktop\Intuk\testing\Imges"
        DEFAULT_LOGOS = r"C:\Users\Akshat Mittal\Desktop\Intuk\testing\LOGOS"
        ...
        self.pauseEvent.set()  # Not paused initially
        self.startTime = None
    ...
    def _buildActions(self, parent):
        ...
        # Buttons container
        btnContainer = ctk.CTkFrame(parent, fg_color="transparent")
        ...
        # Don't pack yet - will show when processing starts
    ...
    def _togglePause(self):
        ...
        if self.paused:
            # Resume - update settings in case they were changed
            self.paused = False
            self.pauseEvent.set()
            self.pauseBtn.configure(
                text="⏸ Pause",
                fg_color=self.colors['warning'],
                hover_color="#e5a914"
            )
            self.progressLabel.configure(text="Resuming with updated settings...")
        else:
            # Pause
            self.paused = True
            ...
            self.progressLabel.configure(text="⏸ PAUSED - You can edit settings now")
    ...
    def _startAutomation(self):
        ...
        self.pauseBtn.pack(side="left", fill="x", expand=True, padx=(6, 0))
