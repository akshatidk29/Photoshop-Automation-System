...
# Default Model Path
DEFAULT_MODEL_PATH = Path(__file__).parent.parent.parent / "modelTowel" / "best.pt"

class TowelModelDetector(InferenceEngine):
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("  Towel Detector Test (Modular)")
    print("="*60)
    
    outputDir.mkdir(parents=True, exist_ok=True)
    
    detector = TowelModelDetector()
